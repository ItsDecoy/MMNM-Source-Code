function onCreate()
	...
	makeLuaSprite('Sky','grandDad/Grand_Dad_BG1_2', -1450, -925);
	...
	makeLuaSprite('GRAND','grandDad/Grand_Dad_BG1_1', -100, -300);
		...
		makeAnimatedLuaSprite('WEEGEE SANIC','grandDad/Sanic_and_Weegee_boppers',-520,260)
