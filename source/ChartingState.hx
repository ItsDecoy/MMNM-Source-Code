...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['MX Stomp', "Plays the MX Stomp and make a jump note.\nValue 1: Note position for J-Note, 0-3"],
		['Wario Slam', "Self explanatory\n\nValue 1: Health Drain"],
		['Alternate Icons', "Changes the health bar icons based on characters\n\nValue 1: Opponent icon\nValue 2: Player icon\n\nExample: (Value 1:'gf')"],
