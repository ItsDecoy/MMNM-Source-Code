...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Fredrick',			'Fredrick',			'Charter\nCharted: Blinked, Pink Forest, Heros Doom, Familiar, and Ground Zero',						'https://twitter.com/FredrickFunny',			'00CED1'],
			...
			['Polar Vortex',				'',			'Coder',								'https://twitter.com/_Polar_Vortex',		'4D5DBD'],
			['MorenoTheCappuccinoChugger',		'',	"Coder",						'https://twitter.com/the_chugger',	'F73838'],
