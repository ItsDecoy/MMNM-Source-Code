...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Ighby',		'ighby',	"'Holy shit he's an awesome coder'",							'https://twitter.com/Ighby_Guy',	'FFBB1B'],
			['Chase Redding',			'Chase',			"Composer\nComposed: Burning Hatred'",							'https://twitter.com/Chase_R_Music_',			'53E52C'],
			['glowylikesdoom',			'Glowy',		"Musician\nComposed: Familiar, Blinked, Pissed, and Wanted\nCredit to @genesismobie for icon",							'https://twitter.com/galwholikesdoom',		'6475F3'],
			['Frog',				'frog',			'Composer\n Composed: Ground Zero and Victimized',								'https://twitter.com/yoshi_epic',		'4D5DBD'],
			['thesmallerestguy',				'Smallerest',			'Composer\n Composed: A Grand Ol Time, and many other misc sounds/songs',								'NA',		'4D5DBD'],
			['Mystica',				'Icon_Mystic',			'Composer\n Composed: Cover-Up',								'https://twitter.com/Mystic69691',		'4D5DBD'],
			['Floofs',				'Floofs',			'Composer\n Composed: ',								'https://twitter.com/FloofsFr',		'4D5DBD'],
