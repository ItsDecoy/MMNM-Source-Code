...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Decoy',			'decoy',		'Charter and Coder\nCharted: Burning Hatred, Pink Forest',						'https://twitter.com/Yoshinova_',		'663399'],
			...
			['Floofs',				'Floofs',			'Composer\n Composed: ',								'https://twitter.com/FloofsFr',		'FFD700'],
			['Scrumbo_',				'scrumbo-icon',			'Artist\n Made: False Hero, MX, Coronation Day, and IHY BGs',								'https://twitter.com/scrumbo_',		'FFC0CB'],
			['Nylonic',				'Nylonic',			'Artist\n Made: False Hero, Dais-eye sprites, MMNM Logo',								'https://twitter.com/ArtNylonic',		'FF0000'],
			['Elias',				'Elias',			'',								'https://twitter.com/elias60985444',		'FFB6C1'],
			...
			['FuriousAntz',				'FuriousAntz',			'Antimator\n Animated: False Hero sprites, Lucas sprites, Cutscenes',								'',		'FF1493'],
			...
			['FriedFrick',				'fried_friedfr',			'Chromatic Maker\nMade: GF Chromatic',								'https://twitter.com/FriedFricky', 	'3333FF'],
